...
| Phase | What crossed | Status |
|---|---|---|
| 5 | family warp deletion — declared `WarpGrammar` | done |
| 6 | family adders and editors — four editors, three adders, `ObjectShape` | done |
| 7a | family resize — declared `MapShape` | done |
| 7b | new map + placement — three placement shapes (`PIN`/`JOIN`/`MINT`) | done |
...
refused in sentences. This doc was the plan for those sentences — for turning
